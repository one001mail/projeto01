...
import { useSessionLookup } from "@/features/session/hooks/useSessionLookup";
      ...
      <section className="py-20">
        <div className="container max-w-lg">
          ...
          <p className="text-muted-foreground text-center mb-8 text-sm">
            Insira o código da sessão para verificar o status atual.
          </p>
          ...
          <div className="glass-card p-6 space-y-4">
            <div>
              ...
              <div className="flex gap-2 mt-1">
                ...
                />
                <Button onClick={search} disabled={loading} variant="hero" className="shrink-0">
